...
class StyleListView(viewsets.ModelViewSet):
...
class AgeGroupListView(viewsets.ModelViewSet):
    queryset = AgeGroup.objects.all()
    serializer_class = AgeGroupSerializer
    permission_classes = [IsStaff, IsVerified]  # Apply the custom permission
   

class ImageCollectionListView(APIView):
...
class ImageCollectionDetailView(APIView):
    serializer_class = ImageCollectionSerializer
